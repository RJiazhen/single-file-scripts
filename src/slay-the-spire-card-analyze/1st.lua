--Alright, so editing this is easier than it looks
--Step 1: Find the card you want to change
--Step 2: Find the value you want to change
--Step 3: Change it and save
--For example, if you wanted to change the cost of Apotheosis to 3:
--          Find the data for Apotheosis (CTRL+F 'Apotheosis')
--          Find the line for "Cost = [number]"
--          Change the line to "Cost = 3"
--A few notes on text:
-- [1|2] means the regular value is 1 but it becomes 2 when the card is upgraded.
-- |Innate] means the card gets Innate when upgraded.
-- [Exhaust| means the card exhausts only when not upgraded
-- \n stands in for a new line (AKA a line break)
-- If you have any questions, ask User:Falterfire


--Oh, one more thing: You can't edit images directly here. You can change the link, but you have to upload them elsewhere and then add the link here.
...
["Cards"] = {
    ...
    NoUpgrade = true,
    Traits = {"Unplayable", "Life Payment"},
    },
    {Name = "Parasite",
    Image = "Parasite.png",
    Color = "Curse",
    ...
    NoUpgrade = true,
    Traits = {"Unplayable", "At the end of your turn, gain 1 Frail."},
    },
    {Name = "Writhe",
    Image = "Writhe.png",
    Color = "Curse",
    ...
    NoUpgrade = true,
    Traits = {"Unplayable", "Whenever this card is drawn, lose 1 Energy.", "Ethereal."},
    },
    {Name = "Wound",
    Image = "Wound.png",
    Color = "Colorless",
